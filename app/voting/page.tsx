...
export default function VotingPage() {
  ...
  const mrFarewellNominees = nominees.filter(
    (nominee) => nominee.category === "Mr. Farewell"
  );
  const missFarewellNominees = nominees.filter(
    (nominee) => nominee.category === "Miss Farewell"
  );

  const handleVote = async (category: string, nomineeId: number) => {
    try {
      ...
      const response = await fetch("/api/votes", {
        ...
        body: JSON.stringify({
          ...
          candidate_Id: nominee.id.toString(),
          category: category,
        }),
      });
      ...
      // Update local state only if vote was recorded successfully
      setVotedFor((prev) => ({
        ...prev,
        [category]: nomineeId,
      }));
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mb-6">
            Vote for your peers in various categories, including Mr. Farewell
            and Miss Farewell. Each nominee has been selected for their unique
        ...
        <div className="mb-16">
          ...
          >
            ...
            <p className="text-gray-400 mt-2">
              Vote for one candidate in each of these special categories
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-gray-800/50 border border-purple-500/20 rounded-xl p-6">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Vote for the student who best represents the spirit of our
                school and has made a significant impact during their time here.
              </p>
                    ...
                    <div className="p-3">
                      ...
                      <div className="mt-2">
                        <Button
                          ...
                          onClick={() =>
                            handleVote("Miss Farewell", nominee.id)
                          }
                          disabled={
                            votedFor["Miss Farewell"] !== null &&
                            votedFor["Miss Farewell"] !== nominee.id
                          }
                        >
                          {votedFor["Miss Farewell"] === nominee.id
        ...
        {selectedCategory !== "All Categories" && (
          <div className="mb-8 p-4 bg-purple-900/20 border border-purple-500/30 rounded-lg">
            ...
            <p className="text-gray-300 text-sm mt-2">
              Vote for the classmate who you think best exemplifies the
              qualities of {selectedCategory.toLowerCase()}.
            </p>
          </div>
        )}
        ...
        {filteredNominees.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-400">
              No nominees found matching your search criteria.
            </p>
            <Button
              variant="outline"
